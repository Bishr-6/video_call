...
export default function VideoCallPage() {
  ...
  const initHandDetection = async () => {
    ...
    handLandmarkerRef.current = await HandLandmarker.createFromOptions(vision, { baseOptions: { modelAssetPath: 'https://storage.googleapis.com/mediapipe-models/hand_handmarker/hand_handmarker/float16/1/hand_landmarker.task', delegate: 'GPU' }, runningMode: 'VIDEO', numHands: 2 })
    runDetection()
  }
